...
class Ui_OverviewPage(object):
    def setupUi(self, OverviewPage):
        ...
        self.labelPendingLightning.setText("0 MBYND")
        ...
        self.labelBalanceBeyondcoin = QtWidgets.QLabel(self.frame_5)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.labelBalanceBeyondcoin.setFont(font)
        self.labelBalanceBeyondcoin.setCursor(QtGui.QCursor(QtCore.Qt.IBeamCursor))
        self.labelBalanceBeyondcoin.setText("0 BYND")
        self.labelBalanceBeyondcoin.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.labelBalanceBeyondcoin.setTextInteractionFlags(QtCore.Qt.LinksAccessibleByMouse|QtCore.Qt.TextSelectableByKeyboard|QtCore.Qt.TextSelectableByMouse)
        self.labelBalanceBeyondcoin.setObjectName("labelBalanceBeyondcoin")
        self.gridLayout_3.addWidget(self.labelBalanceBeyondcoin, 1, 1, 1, 1)
        ...
        self.labelBalanceLightning.setText("0 MBYND")
        ...
        self.labelBeyondcoin = QtWidgets.QLabel(self.frame_5)
        self.labelBeyondcoin.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.labelBeyondcoin.setObjectName("labelBeyondcoin")
        self.gridLayout_3.addWidget(self.labelBeyondcoin, 0, 1, 1, 1)
        self.labelPendingBeyondcoin = QtWidgets.QLabel(self.frame_5)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.labelPendingBeyondcoin.setFont(font)
        self.labelPendingBeyondcoin.setCursor(QtGui.QCursor(QtCore.Qt.IBeamCursor))
        self.labelPendingBeyondcoin.setText("0 BYND")
        self.labelPendingBeyondcoin.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.labelPendingBeyondcoin.setTextInteractionFlags(QtCore.Qt.LinksAccessibleByMouse|QtCore.Qt.TextSelectableByKeyboard|QtCore.Qt.TextSelectableByMouse)
        self.labelPendingBeyondcoin.setObjectName("labelPendingBeyondcoin")
        self.gridLayout_3.addWidget(self.labelPendingBeyondcoin, 2, 1, 1, 1)
        self.lineBeyondcoinBalance = QtWidgets.QFrame(self.frame_5)
        self.lineBeyondcoinBalance.setFrameShape(QtWidgets.QFrame.HLine)
        self.lineBeyondcoinBalance.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.lineBeyondcoinBalance.setObjectName("lineBeyondcoinBalance")
        self.gridLayout_3.addWidget(self.lineBeyondcoinBalance, 3, 0, 1, 2)
        ...
        self.labelBeyondcoinTotal = QtWidgets.QLabel(self.frame_5)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.labelBeyondcoinTotal.setFont(font)
        self.labelBeyondcoinTotal.setCursor(QtGui.QCursor(QtCore.Qt.IBeamCursor))
        self.labelBeyondcoinTotal.setText("0 BYND")
        self.labelBeyondcoinTotal.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.labelBeyondcoinTotal.setTextInteractionFlags(QtCore.Qt.LinksAccessibleByMouse|QtCore.Qt.TextSelectableByKeyboard|QtCore.Qt.TextSelectableByMouse)
        self.labelBeyondcoinTotal.setObjectName("labelBeyondcoinTotal")
        self.gridLayout_3.addWidget(self.labelBeyondcoinTotal, 4, 1, 1, 1)
        ...
        self.labelLightningTotal.setText("0 MBYND")
    ...
    def retranslateUi(self, OverviewPage):
        ...
        self.labelBalanceBeyondcoin.setToolTip(_translate("OverviewPage", "Your current on chain balance"))
        ...
        self.labelBeyondcoin.setText(_translate("OverviewPage", "Beyondcoin:"))
        self.labelPendingBeyondcoin.setToolTip(_translate("OverviewPage", "Your total not yet confirmed on chain balance"))
        self.labelTotal.setText(_translate("OverviewPage", "Total:"))
        self.labelBeyondcoinTotal.setToolTip(_translate("OverviewPage", "Your total on chain balance"))
