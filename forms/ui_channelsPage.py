...
class Ui_ChannelsPage(object):
    ...
    def retranslateUi(self, ChannelsPage):
        ...
        self.spinNewChannelAmount.setToolTip(_translate("ChannelsPage", "The amount of microbeyondcoin used to fund the channel"))
        ...
        self.label_6.setText(_translate("ChannelsPage", "MBYND"))
        self.spinSetFeesPpm.setToolTip(_translate("ChannelsPage", "Ppm (proportionaly per millionth) fees : amount in bynd to charge for each million microbeyondcoin routed through"))
        self.label_9.setText(_translate("ChannelsPage", "BYND"))
        ...
        self.label_10.setText(_translate("ChannelsPage", "Incoming (mbynd)"))
        self.label_8.setText(_translate("ChannelsPage", "Amount (mbynd)"))
