...
class Ui_ReceivePage(object):
    ...
    def retranslateUi(self, ReceivePage):
        ...
        self.label.setToolTip(_translate("ReceivePage", "Value in millibeyondcoins of invoice to request."))
        self.label.setText(_translate("ReceivePage", "Value :"))
        self.spinValue.setToolTip(_translate("ReceivePage", "Value in millibeyondcoins of invoice to request."))
